...
- [SH-P0-5 元组值构造 + 解构（多返回值）](./leaf/sh-p0-5-tuple-value.md) → 0.2.0-N（复审补遗；类型层已就绪，值/解构/多返回缺失）
- [SH-P0-6 `if let` / `while let` 模式控制流](./leaf/sh-p0-6-if-let.md) → 0.2.0-O（复审补遗；语言完全缺失）
