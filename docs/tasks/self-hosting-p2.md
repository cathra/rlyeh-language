...
| SH-P2-7 | 前端自举 PoC（lexer/parser/ast/macro 用 Rlyeh 重写） | 0.2.0-M | rlyeh-driver / lexer / parser / ast / macro / tests | [leaf](./leaf/sh-p2-7-driver.md) | 🟡 进行中（M-M1a 切片1 落地：Rlyeh 版 lexer + 差分对拍 harness 通过） |
