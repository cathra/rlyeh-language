...
fn temp_project() -> PathBuf {
    ...
    let dir = std::env::temp_dir().join(format!("rlyeh-string-cmp-{}-{seq}", std::process::id()));
...
fn main() {
    ...
    println(String::from("rlyeh") > String::from("rust"));
    println(String::from("rust") > String::from("rlyeh"));
}
"#,
    );
    assert_eq!(out, "true\nfalse\nfalse\ntrue\n");
