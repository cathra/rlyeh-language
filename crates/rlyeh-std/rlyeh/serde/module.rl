...
//
// 组成：
//   serde/traits.rl        protocol Serialize / Deserialize      → 子模块 serde::traits
...
//
// module 声明顺序 = 收集期注册顺序：traits / error 先于 serializer / deserializer /
// impls（后者引用协议与工具函数）。

module traits;
pub import traits::Serialize;
pub import traits::Deserialize;
module error;
