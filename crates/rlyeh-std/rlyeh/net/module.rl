...
// 目录化（2026-08）：原 net.zeta 拆分 →
//   net/module.zeta     （模块根：socket 自由函数 socketpair_stream/fd_at/send_all/recv_some/tcp_connect/hostname）
//   net/byteorder.zeta（字节打包：htons/sockaddr_in4_with_layout/sockaddr_in4/int_buf4/octets_to_string/parse_sockaddr）
//   net/addr.zeta    （Ipv4Octets/ipv4_octets/SocketAddr/Shutdown）
//   net/tcp.zeta     （TcpStream/TcpListener）
//   net/http.zeta    （ParsedUrl/parse_url/read_all/parse_status/Response/HttpClient/parse_response）
// 位运算全链路打通（& | ^ << >>）后启用：
